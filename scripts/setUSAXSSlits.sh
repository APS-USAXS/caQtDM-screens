...
caput 9idcLAX:USAXS_Pin:USAXS_hslit_ap $USAXSH
caput 9idcLAX:USAXS_Pin:USAXS_vslit_ap $USAXSV
# Guard horizonal and vertical
export GUARDH=`caget -t 9idcLAX:GSlit1H:size`
export GUARDV=`caget -t 9idcLAX:GSlit1V:size`
caput 9idcLAX:USAXS_Pin:USAXS_hgslit_ap $GUARDH
caput 9idcLAX:USAXS_Pin:USAXS_vgslit_ap $GUARDV
