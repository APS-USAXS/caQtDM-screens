...
# A version kevin built to test fix for cpu-usage problem
export CAQTDM=/home/beams/USAXS/caQtDM_Binaries-TESTING/caQtDM
...
addScreenPath      DSERV_EPICS_DIR       synApps_5_7/ioc/9id/9idcApp/op/adl
...
export LD_LIBRARY_PATH=/home/beams/USAXS/caQtDM_Binaries-TESTING
export LD_LIBRARY_PATH=${LD_LIBRARY_PATH}:/APSshare/caqtdm/lib
