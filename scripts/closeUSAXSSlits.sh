...
export USAXSH=`caget -t 9idcLAX:USAXS_Pin:USAXS_hslit_ap`
export USAXSV=`caget -t 9idcLAX:USAXS_Pin:USAXS_vslit_ap`
caput 9idcLAX:m58:c2:m8.VAL $USAXSH
caput 9idcLAX:m58:c2:m7.VAL $USAXSV
# Guard horizonal and vertical
export GUARDH=`caget -t 9idcLAX:USAXS_Pin:USAXS_hgslit_ap`
export GUARDV=`caget -t 9idcLAX:USAXS_Pin:USAXS_vgslit_ap`
